import { useRouter } from 'expo-router'; // Expo Router'dan useRouter'ı çekiyoruz
import { useState } from 'react';
import { ActivityIndicator, Alert, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';
import { supabase } from '../../supabase'; // Supabase yolunu kendi dosyana göre düzelt

export default function LoginScreen() {
  const router = useRouter(); // Navigasyon için bunu kullanacağız
  ...
  const handleLogin = async () => {
    ...
    if (error) {
      ...
      Alert.alert('Harika!', 'Giriş başarılı.');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>EtkinlikApp'e Hoş Geldin</Text>
      ...
      <TouchableOpacity onPress={() => router.push('/register')} style={styles.linkButton}>
        <Text style={styles.linkText}>Hesabın yok mu? Hemen Kaydol</Text>
      </TouchableOpacity>
    </View>
  );
}
